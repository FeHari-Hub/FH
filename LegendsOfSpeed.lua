...
if not Success then
	warn("\nHaridade Library - Failed to load Feather Icons. Error code: " .. Response .. "\n")
end	
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if HaridadeLib.Flags[a] then
			...
			warn("Haridade Library Config Loader - Could not find ", a ,b)
		end
	end)
end
...
function HaridadeLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Haridade Library"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Haridade Library"
