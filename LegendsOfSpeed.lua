local Rayfield = loadstring(game:HttpGet("https://raw.githubusercontent.com/FeHari/HaridadeScript/main/Connector.lua"))()
...
local Window = Rayfield:CreateWindow({
    ...
    Discord = {
       Enabled = false,
       Invite = "uydz6pZWMk", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ABCD would be ABCD.
