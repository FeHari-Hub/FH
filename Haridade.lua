...
local ConfigurationExtension = "Haridade - LOS ⚡"
...
local Rayfield = game:GetObjects("rbxassetid://11699739809")[1]
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name,Image)
		...
		function Tab:CreateLabel(LabelText)
			...
			function LabelValue:Visible(Value)
				Label.Visible = Value
			end
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			function DropdownSettings:Visible(Value)
		...
		function Tab:CreateKeybind(KeybindSettings)
			...
			function KeybindSettings:Visible(Value)
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			function ToggleSettings:Visible(Value)
		...
		function Tab:CreateSlider(SliderSettings)
			...
			function SliderSettings:Visible(Value)
